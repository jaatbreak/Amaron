...
/*  Start Admin Route  */
    ...
    Route::group([ 'prefix' => 'admin' , 'middleware' => ['auth', 'admin']], function(){
        ...
        /*  Start Admin Products  */
            ...
            Route::match(['get', 'post'], 'wallet', [WalletController::class, 'wallet'])->name('admin/wallet');
            Route::match(['get', 'post'], 'wallet/add', [WalletController::class, 'add_wallet'])->name('admin/wallet/add');
            Route::match(['get', 'post'], 'wallet/edit/{id}', [WalletController::class, 'edit_wallet'])->name('admin/wallet/edit');
            Route::match(['get', 'post'], 'wallet/delete', [WalletController::class, 'delete_wallet'])->name('admin/wallet/delete');
...
//   Route::get('/cart', [CommonController::class, 'cart'])->name('cart');
  ...
  Route::match(['get', 'post'], 'track-order/{order_id}', [CommonController::class, 'track_shipment']);
  //Route::match(['get', 'post'], 'track-order/{order_id}', [CommonController::class, 'track_shipment'])->name('track.order');
