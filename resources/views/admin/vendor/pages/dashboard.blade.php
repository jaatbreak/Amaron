...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Amaronshop /</span> Vendor Dashboard
</h4>
  ...
  <div class="col-sm-6 col-lg-3 mb-4">
    <div class="card card-border-shadow-primary">
      <div class="card-body">
        ...
        <p class="mb-1"><a href="<?= url('vendor/product') ?>">Total Products</a></p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-lg-3 mb-4">
    ...
    <div class="card card-border-shadow-danger">
      <div class="card-body">
        <div class="d-flex align-items-center mb-2 pb-1">
          ...
          <h4 class="ms-1 mb-0"> <?= App\Models\Checkout::where('vendor_id',Auth::id())->count(); ?></h4>
        </div>
        <p class="mb-1"><a href="<?= url('vendor/order') ?>">Total Orders</a></p>
      </div>
    </div>
  </div>
